...
export default class RegisterRestaurant extends Component {
    ...
    async handleCreateAccountBtn() {
        const { userName, userEmail, userPassword, userConfirmPassword, userCity, userCountry, userGender, userAge, userProfileImage, userTNC, info } = this.state;
        ...
        if (!userName.match(userNameFormate)) {
            ...
            this.setState({
                ...
                this.setState({
                    userTNC: "",
                    showError: true,
                    registerFormError: "Enter restaurant description.",
                })
            } else {
                            ...
                            <form action="javascript:void(0)">
                                <div className="form-row">
                                    <div className="form-group col-md-6">
                                        ...
                                        <input type="text" className="form-control" id="userName" placeholder="Full Name" onKeyUp={(e) => this.handleUserName(e.target.value)} required/>
                                    </div>
                                    <div className="form-group col-md-6">
                                ...
                                <div className="form-row">
                                    <div className="form-group col-md-6">
                                        ...
                                        <input type="password" className="form-control" id="userPassword" placeholder="Password" onKeyUp={(e) => this.handleUserPassword(e.target.value)} required/>
                                    </div>
                                    <div className="form-group col-md-6">
                                        <label htmlFor="userConfirmPassword">Confirm Password</label>
                                        <input type="password" className="form-control" id="userConfirmPassword" placeholder="Password" onKeyUp={(e) => this.handleUserConfirmPassword(e.target.value)} required/>
                                    </div>
                                </div>
                                <div className="form-row">
                                    ...
                                    <div className="form-group col-md-2">
                                        ...
                                        <input type="number" className="form-control" id="userAge" onKeyUp={(e) => this.handleUserAge(e.target.value)} required/>
                                    </div>
                                    <div className="form-group col-md-6">
                                        <p className="mb-2">Profile Image</p>
                                        <div className="custom-file">
                                            <input type="file" className="custom-file-input" id="userProfileImage" onChange={this.handleUserProfileImage} required/>
                                    ...
                                    <div className="form-group col-md-6">
                                        ...
                                        <textarea
                                            ...
                                            onChange={(e) => this.handleInfo(e.target.value)}
                                            required
                                        />
                                    </div>
                                </div>
