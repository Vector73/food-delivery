...
export default class Login extends Component {
    ...
    handleUserPhone(userPhone) {
        const userPhoneFormat = /^\d{10}$/;
        // console.log(userPhone);
        if (userPhone.match(userPhoneFormat)) {
            this.setState({
                showError: false,
                registerFormError: "",
                userPhone: userPhone,
            ...
            this.setState({
                showError: true,
                registerFormError: "Enter valid phone number",
            })
            return false;
        }
    }
    ...
    async handleCreateAccountBtn() {
        const { userName, userEmail, userPassword, userConfirmPassword, userGender, userPhone, userAge, userProfileImage, userTNC } = this.state;
        ...
        if (!userName.match(userNameFormate)) {
        ...
        } else if (!this.handleUserPhone(userPhone)) {
            return;
        } else {
            ...
            try {
                ...
                this.setState({
                    showError: true,
                    registerFormError: "This email address is already registered!",
                    userPassword: "",
                });
            }
        }
    ...
    async handleLoginNowBtn() {
        ...
        try {
            ...
            this.setState({
                showError: true,
                registerFormError: "Invalid email or password!",
                userPassword: "",
            });
            console.log(error)
        }
                            ...
                            <form action="javascript:void(0)">
                                ...
                                <div className="form-row">
                                    <div className="form-group col-md-6">
                                        ...
                                        <input type="number" className="form-control" id="userPhone" onKeyUp={(e) => this.handleUserPhone(e.target.value)} />
                                    </div>
                                    <div className="form-group col-md-6">
