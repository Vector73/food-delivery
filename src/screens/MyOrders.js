                ...
                if (myOrder[val].status === "PENDING") {
                    return (
                        <div className="container border-bottom pb-2 px-lg-0 px-md-0 mb-4" key={myOrder[val].id}>
                            ...
                            <div class="p-3" style={{ wordWrap: "break-word" }}>
                                <p class="text-secondary">Address: {myOrder[val].address}</p>
                            </div>
                            {
                                    ...
                                    return (
                                        <div className="row mb-3" key={val2}>
                                            ...
                                            <div className="col-lg-2 col-md-3 col-sm-12 px-0">
                                                <h6 className="">x{myOrder[val].itemsList[val2].quantity}</h6>
                                            </div>
                            ...
                            <p><b className="mr-4">Order Time:</b>{myOrder[val].order_timestamp.toDate().toLocaleString()}</p>
                        </div>
                    )
                }
            })
                        ...
                        <div className="container border-bottom pb-2 px-lg-0 px-md-0 mb-4" key={myOrder[val].id}>
                            ...
                            <div className="col-lg-6 col-md-6 col-12">
                                <div>
                                    ...
                                    {myOrder[val].order_timestamp.toDate().toLocaleString()}
                                </div>
                                <div>
                                    <b className="mr-4">Delivery Time:</b>
                                    {myOrder[val].delivery_timestamp.toDate().toLocaleString()}
                                </div>
                            </div>
                        </div>
                    )
